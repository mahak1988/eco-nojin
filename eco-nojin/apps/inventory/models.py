...
class InventoryItem(Base):
    ...
    category: Mapped[str] = mapped_column(String(40), nullable=False)  # seed|fertilizer|pesticide|tool
    ...
    npk: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)  # e.g. 20-20-20
