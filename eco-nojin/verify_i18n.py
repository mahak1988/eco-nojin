...
def main():
    ...
    with open(fa_file, encoding='utf-8') as f:
        fa_data = json.load(f)
    ...
    print("   ✅ fa.json sorted and saved")

    with open(en_file, 'w', encoding='utf-8') as f:
        json.dump(en_sorted, f, ensure_ascii=False, indent=2)
    print("   ✅ en.json sorted and saved")
    ...
    print("  Files reviewed: fa.json, en.json")
    print("  Files updated: fa.json (sorted), en.json (sorted)")
