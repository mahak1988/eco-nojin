...
print("=" * 80)
print("📚 CREATING COMPLETE ACADEMY MODULE")
print("=" * 80)

# ============================================================
# BACKEND: Academy Module
# ============================================================
print("\n🔧 Creating backend academy module...")
...
Path('api/modules/academy/models.py').write_text(academy_models, encoding='utf-8')
print("✅ Created api/modules/academy/models.py")
...
Path('api/modules/academy/router.py').write_text(academy_router, encoding='utf-8')
print("✅ Created api/modules/academy/router.py")

# 3. Backend __init__.py
academy_init = '''from . import router
'''
Path('api/modules/academy/__init__.py').write_text(academy_init, encoding='utf-8')
print("✅ Created api/modules/academy/__init__.py")

print("\n✅ Backend academy module created!")
print("   - Models: Course, Lesson, Enrollment, Certificate")
print("   - Router: 5 endpoints")
print("   - Mock data: 6 courses")
print("   - Standards: FAO, IPCC, SDGs, WMO, ISO, UNCCD")