...
export default function Page() {
  ...
  const title = dict?.pages.privacy?.title || (isPersian ? 'حریم خصوصی' : 'Privacy');
  const subtitle = dict?.pages.privacy?.subtitle || (isPersian ? 'این صفحه در حال توسعه است' : 'This page is under development');

  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white dark:from-gray-900 dark:to-gray-800 pt-24">
