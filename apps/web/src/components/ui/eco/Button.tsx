/**
 * ============================================================================
 *  EcoButton — Styled button component for EcoNojin UI
 * ============================================================================
 */
...
export interface EcoButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
...
export function EcoButton({
  ...
  const variantClasses = {
    ...
    outline: "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-emerald-500 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-200",
