// Simulator UI strings — en / fa / ar (complete parallel packs)
...
const FA = {
  title: "شبیه‌سازها",
  subtitle: "مدل‌های شبیه‌سازی اقلیم، آب، کشاورزی و انرژی",
  searchPlaceholder: "جست‌وجوی شبیه‌ساز…",
  filterAll: "همه",
  filter_idle: "آماده",
  filter_running: "در حال اجرا",
  filter_done: "تکمیل‌شده",
  run: "اجرا",
  stop: "توقف",
  reset: "بازنشانی",
  params: "پارامترها",
  output: "خروجی شبیه‌سازی",
  progress: "پیشرفت",
  runsLabel: "اجرا",
  exportAll: "خروجی CSV",
  kpi_runs: "کل اجراها",
  kpi_running: "در حال اجرا",
  kpi_done: "تکمیل‌شده",
  kpi_models: "مدل‌ها",
  st_idle: "آماده",
  st_running: "در حال اجرا",
  st_done: "تکمیل‌شده",
  backend_online: "شبیه‌ساز (سرور)",
  backend_offline: "حالت محلی",
  backend_loading: "در حال اتصال…",
  n_climate: "مدل اقلیمی",
  n_water: "منابع آب",
  n_agriculture: "عملکرد کشاورزی",
  n_energy: "شبکهٔ انرژی",
  d_climate: "دما، بارش، رویدادهای شدید و NDVI را از CO₂ و حساسیت اقلیمی شبیه‌سازی می‌کند.",
  ...
  p_co2: "غلظت CO₂",
  p_sens: "حساسیت اقلیمی",
  p_rain: "بارش",
  p_wdemand: "تقاضای آب",
  p_awater: "آبیاری",
  p_atemp: "دما",
  p_soil: "کیفیت خاک",
  p_solar: "ظرفیت خورشیدی",
  p_wind: "ظرفیت بادی",
  p_edemand: "تقاضای برق",
  u_ppm: "ppm",
  u_c: "°C",
  u_mm: "mm",
  u_pct: "٪",
  u_mw: "MW",
  l_temp: "دما (°C)",
  l_reservoir: "موجودی مخزن (٪)",
  l_yield: "شاخص عملکرد",
  l_generation: "تولید (MW)",
  l_demand: "تقاضا (MW)",
  l_precip: "بارش (mm)",
  l_extreme: "رویدادهای شدید / سال",
  l_ndvi: "NDVI",
...
export const SIM_STR: Record<SimLang, SimStrings> = {
  ...
  en: {
    title: "Simulators",
    subtitle: "Climate, water, agriculture and energy models",
    ...
    st_running: "Running",
    st_done: "Completed",
    backend_online: "simulators (server)",
    backend_offline: "Local mode",
    backend_loading: "Connecting…",
    n_climate: "Climate Model",
    n_water: "Water Resources",
    n_agriculture: "Agriculture Yield",
    n_energy: "Energy Grid",
    ...
    p_sens: "Climate sensitivity",
    p_rain: "Rainfall",
    p_wdemand: "Water demand",
    p_awater: "Irrigation",
    p_atemp: "Temperature",
    p_soil: "Soil quality",
    p_solar: "Solar capacity",
    p_wind: "Wind capacity",
    p_edemand: "Power demand",
    u_ppm: "ppm",
    u_c: "°C",
    u_mm: "mm",
    u_pct: "%",
    ...
    l_reservoir: "Reservoir level (%)",
    l_yield: "Yield index",
    l_generation: "Generation (MW)",
    l_demand: "Demand (MW)",
    l_precip: "Precipitation (mm)",
    l_extreme: "Extreme events / yr",
    l_ndvi: "NDVI",
    csvHeaders: "Simulator,Status,Runs,Progress%,Parameters",
  },
  ar: {
    title: "المحاكيات",
    subtitle: "نماذج المناخ والمياه والزراعة والطاقة",
    searchPlaceholder: "ابحث في المحاكيات…",
    filterAll: "الكل",
    filter_idle: "جاهز",
    ...
    reset: "إعادة تعيين",
    params: "المعاملات",
    output: "ناتج المحاكاة",
    progress: "التقدم",
    runsLabel: "تشغيل",
    exportAll: "تصدير CSV",
    kpi_runs: "إجمالي التشغيلات",
    kpi_running: "قيد التشغيل",
    kpi_done: "مكتملة",
    kpi_models: "النماذج",
    st_idle: "جاهز",
    st_running: "قيد التشغيل",
    st_done: "مكتمل",
    backend_online: "محاكيات (الخادم)",
    backend_offline: "الوضع المحلي",
    backend_loading: "جارٍ الاتصال…",
    n_climate: "نموذج المناخ",
    n_water: "موارد المياه",
    n_agriculture: "إنتاجية الزراعة",
    n_energy: "شبكة الطاقة",
    ...
    p_co2: "تركيز CO2",
    p_sens: "الحساسية المناخية",
    p_rain: "الهطول",
    p_wdemand: "طلب المياه",
    p_awater: "الري",
    p_atemp: "الحرارة",
    p_soil: "جودة التربة",
    p_solar: "السعة الشمسية",
    p_wind: "سعة الرياح",
    p_edemand: "طلب الكهرباء",
    u_ppm: "ppm",
    u_c: "°C",
    u_mm: "mm",
    u_pct: "٪",
    u_mw: "MW",
    l_temp: "الحرارة (°C)",
    l_reservoir: "مستوى الخزان (٪)",
    l_yield: "مؤشر الإنتاج",
    l_generation: "الإنتاج (MW)",
    l_demand: "الطلب (MW)",
    l_precip: "الهطول (mm)",
    l_extreme: "الأحداث المتطرفة / سنة",
    l_ndvi: "NDVI",
