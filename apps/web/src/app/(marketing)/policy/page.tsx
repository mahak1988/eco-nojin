...
import { ArrowRight, Scale, Microscope, Eye, Heart, Shield, Coins, Brain, Leaf, Mail, Users, FileText, CheckCircle, AlertTriangle, Globe, Lock, RefreshCw, HelpCircle, Award, Target } from "lucide-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-slate-900/50 rounded-xl p-6 border-r-4 border-emerald-500">
                <h3 className="text-lg font-bold text-emerald-400 mb-3 flex items-center gap-2">
                  <Users className="h-5 w-5" /> مأموریت (Mission)
                </h3>
                <p className="text-slate-300 leading-relaxed">
        ...
        <div className="bg-gradient-to-br from-emerald-900/20 to-teal-900/20 border border-emerald-500/30 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {[
              ...
              { email: "legal@econojin.com", desc: "امور حقوقی، قراردادها و مالکیت فکری", icon: Users },
            ].map((contact, idx) => {
