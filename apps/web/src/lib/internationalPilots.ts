...
import { MENAP_EXTRA } from "./menapExtraPilots";
...
const CORE: IntlPilotSite[] = [
  {
    ...
    kpis: [
      ...
      { labelFa: "کاهش رواناب اوج", target: "≥30", unit: "%" },
      { labelFa: "اشتغال روستایی", target: "0.5", unit: "job/ha" },
    ],
  ...
  },
  {
    ...
    lon: 50.24,
    areaHaTarget: 8000,
    focusFa: "کاهش شوری، زهکشی کنترل‌شده، بهره‌وری آب، غذای سالم",
    focusEn: "Salinity, drainage, water productivity, healthy food",
    ...
    kpis: [
      ...
      { labelFa: "بهره‌وری آب زیرزمینی", target: "+15", unit: "% WP" },
      { labelFa: "سطح مسیر ارگانیک", target: "≥30", unit: "%" },
    ],
  ...
  },
  {
    ...
    kpis: [
      ...
      { labelFa: "کاهش فرسایش", target: "≥40", unit: "%" },
    ],
  ...
  },
  {
    ...
    lon: 51.59,
    areaHaTarget: 4000,
    focusFa: "مدیریت برفاب، تغذیه مصنوعی، حفاظت مرتع",
    focusEn: "Snowmelt, artificial recharge, rangeland",
    hpPackages: ["HP-01", "HP-07", "HP-08", "HP-09", "HP-12"],
    models: ["SWAT+", "WEAP", "RothC"],
    standards: ["FAO pastoral", "GSOC-MRV", "LDN"],
    kpis: [
      { labelFa: "تغذیه برفاب", target: "+20", unit: "%" },
      { labelFa: "کاهش تبخیر با مالچ/پوشش", target: "≥15", unit: "%" },
    ],
  ...
  },
  {
    ...
    lon: 51.67,
    areaHaTarget: 2000,
    focusFa: "بیلان آب، AquaCrop، NDVI Planetary، اعتبارسنجی مدل",
    focusEn: "Water balance, AquaCrop, Planetary NDVI, validation",
    ...
    kpis: [
      ...
      { labelFa: "بهره‌وری آب زیرزمینی", target: "+10", unit: "%" },
    ],
  ...
  },
  {
    ...
    lon: 57.74,
    areaHaTarget: 3500,
    focusFa: "ریزآبخیز، مالچ، بیوچار، کاهش تبخیر",
    focusEn: "Micro-watershed, mulch, biochar, evaporation cut",
    ...
    kpis: [
      ...
      { labelFa: "کاهش تبخیر", target: "≥25", unit: "%" },
    ],
  ...
  },
  {
    ...
    lon: 62.2,
    areaHaTarget: 2500,
    focusFa: "احیای معیشت، SWC مشارکتی، توسعه روستایی",
    focusEn: "Livelihoods, participatory SWC, rural development",
  ...
  },
  {
    ...
    lon: 47.8,
    areaHaTarget: 4000,
    focusFa: "شوری، نخلستان پایدار، کیفیت آب",
    focusEn: "Salinity, date palm, water quality",
    hpPackages: ["HP-04", "HP-05", "HP-06", "HP-07"],
    models: ["QUAL2K-proxy", "AquaCrop", "WEAP"],
    standards: ["FAO salinity", "IPCC AFOLU"],
    kpis: [
      { labelFa: "کاهش EC", target: "≥15", unit: "%" },
      { labelFa: "بقای نخل", target: ">85", unit: "%" },
    ],
    phasePlan: ["نمونه‌برداری", "مالچ و زهکش", "مدل کیفیت آب", "آموزش"],
    priority: 2,
    icon: "🌴",
  },
  {
    ...
    focusEn: "Water productivity, CA, carbon credits",
    hpPackages: ["HP-05", "HP-06", "HP-07", "HP-12"],
    models: ["AquaCrop", "RothC", "WEAP"],
    standards: ["Verra VM0042", "GSOC-MRV", "EU Organic"],
    kpis: [
      { labelFa: "kg محصول / m³ آب", target: "+20", unit: "%" },
      { labelFa: "SOC", target: "+0.2", unit: "%/3yr" },
    ],
    phasePlan: ["Baseline SOC", "CA", "MRV", "Verra path"],
    priority: 2,
    icon: "💧",
  },
  {
    ...
    lon: 10.1,
    areaHaTarget: 2000,
    focusFa: "jessour + مهندسی، زیتون دیم، کاهش رواناب",
    focusEn: "jessour + engineering, rainfed olive, runoff cut",
    ...
    phasePlan: ["مستندسازی جسور", "بهینه‌سازی", "FFS", "پایش"],
    priority: 2,
    icon: "🫒",
  },
  {
    ...
    lon: -9.6,
    areaHaTarget: 3000,
    focusFa: "آب زیرزمینی، آرگان، تغذیه مصنوعی",
    focusEn: "Groundwater, argan, managed recharge",
    ...
    kpis: [
      ...
      { labelFa: "تغذیه مصنوعی", target: "+20", unit: "% volume" },
    ],
  ...
  },
  {
    ...
    lon: 30.84,
    areaHaTarget: 2500,
    focusFa: "بازچرخانی آب، کاهش تبخیر، کربن خاک",
    focusEn: "Water reuse, evaporation cut, soil carbon",
  ...
  },
  {
    ...
    lon: 42.5,
    areaHaTarget: 2000,
    focusFa: "تراس + SWC، مرتع، کاهش رواناب",
    focusEn: "Terraces + SWC, rangeland, runoff cut",
  ...
  },
  {
    ...
    lon: 67.0,
    areaHaTarget: 3000,
    focusFa: "دیم مقاوم، زای، تغذیه کم‌عمق",
    focusEn: "Rainfed resilience, zai, shallow recharge",
    hpPackages: ["HP-03", "HP-04", "HP-05", "HP-09", "HP-12"],
    models: ["AquaCrop", "RUSLE", "RothC"],
    standards: ["WOCAT zai", "LDN", "FAO CA"],
    kpis: [
      { labelFa: "نفوذ پس از باران", target: "+40", unit: "%" },
      { labelFa: "غذای دیم پایدار", target: ">60", unit: "% سبز شدن" },
    ],
  ...
  },
  {
    ...
    lon: 2.1,
    areaHaTarget: 5000,
    focusFa: "انتقال دانش زای/هلالی، کربن خاک، معیشت",
    focusEn: "WOCAT zai transfer, soil carbon, livelihoods",
    ...
    kpis: [
      ...
      { labelFa: "توسعه روستایی", target: "0.4", unit: "job/ha" },
    ],
  ...
  },
  {
    ...
    lon: 32.48,
    areaHaTarget: 2500,
    focusFa: "فرونشست آبخوان، CA، بیلان آب",
    focusEn: "Aquifer stress, CA, water balance",
    hpPackages: ["HP-05", "HP-06", "HP-07", "HP-12"],
...
export const INTL_PILOTS: IntlPilotSite[] = [
  ...CORE,
  ...(MENAP_EXTRA as unknown as IntlPilotSite[]),
];
