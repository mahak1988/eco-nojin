/**
 * Lightweight i18n (English source of truth; fa/ar packs).
 * Source code stays English; UI strings come from locale JSON only.
 */
...
/** Translate key like "common.nav.farms" or "auth.loginTitle". */
