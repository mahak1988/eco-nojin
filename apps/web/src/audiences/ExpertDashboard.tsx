/**
 * ============================================================================
 *  ExpertDashboard — dashboard for expert audience (i18n-aware)
 * ============================================================================
 */
...
export function ExpertDashboard(): JSX.Element {
    ...
    <div dir={dir} className="mx-auto max-w-7xl px-4 py-8">
      <header className="mb-6">
        <div className="flex items-center gap-3">
          <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-purple-50 text-3xl">🔬</span>
          <div>
            <h1 className="text-2xl font-bold text-gray-900">{t("audiences.expert.title")}</h1>
            <p className="mt-1 text-sm text-gray-600">{t("audiences.expert.subtitle")}</p>
          </div>
        </div>
      </header>
