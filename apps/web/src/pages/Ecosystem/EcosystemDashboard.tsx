/**
 * ============================================================================
 *  EcosystemDashboard — ecosystem dashboard (i18n-aware)
 * ============================================================================
 */
...
export function EcosystemDashboard(): JSX.Element {
  ...
  return (
    <div dir={dir} className="mx-auto max-w-7xl px-4 py-8">
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">{t("ecosystem.title")}</h1>
        <p className="mt-1 text-sm text-gray-600">{t("ecosystem.subtitle")}</p>
      </header>
        ...
        <div className="space-y-6">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-gray-600">{t("ecosystem.totalValue")}</p>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-gray-600">{t("ecosystem.regions")}</p>
                <span className="text-2xl" aria-hidden="true">📍</span>
              </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-gray-600">{t("ecosystem.average")}</p>
                <span className="text-2xl" aria-hidden="true">📊</span>
              </div>
          ...
          <div dir={dir} className="overflow-hidden rounded-xl border border-gray-200 bg-white">
            <div className="border-b border-gray-200 px-5 py-3">
              <h3 className="text-sm font-semibold text-gray-900">{t("ecosystem.tableTitle")}</h3>
            </div>
              ...
              <table className="w-full text-start text-sm">
                <thead className="bg-gray-50 text-xs uppercase text-gray-500">
                  <tr>
                    ...
                    <th className="px-5 py-3 font-medium">{t("ecosystem.tableValue")}</th>
