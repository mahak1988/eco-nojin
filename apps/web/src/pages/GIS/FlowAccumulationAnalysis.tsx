/**
 * ============================================================================
 *  FlowAccumulationAnalysis — gis.flowAccumulation analysis page (i18n-aware)
 * ============================================================================
 */
...
export function FlowAccumulationAnalysis(): JSX.Element {
  const { t, dir, language } = useLanguage();

  return (
    <div dir={dir} className="mx-auto max-w-5xl px-4 py-8">
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">{t("gis.flowAccumulation.title")}</h1>
        <p className="mt-1 text-sm text-gray-600">{t("gis.flowAccumulation.subtitle")}</p>
      </header>
      ...
      <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6">
        ...
        <p className="mt-2 text-sm leading-6 text-gray-600">{t("gis.flowAccumulation.resultDescription")}</p>
      </div>
    </div>
  );
}
