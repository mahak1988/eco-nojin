/**
 * ============================================================================
 *  Home.tsx — Premium Landing Page for Eco Nojin
 * ============================================================================
 */
...
export function Home(): JSX.Element {
  ...
  return (
    <div dir={dir} className="min-h-screen bg-white font-sans text-gray-900 antialiased selection:bg-emerald-100 selection:text-emerald-900">
      
      {/* 1. Navigation Bar (Glassmorphism) */}
      <nav className="fixed top-0 z-50 w-full border-b border-white/10 bg-white/70 backdrop-blur-md transition-all">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            <Link to="/login" className="rounded-lg px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-100">
              {t("home.nav.login")}
            </Link>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-4 py-1.5 text-sm font-medium text-emerald-800 mb-8">
          ...
          <div className="mt-10 flex items-center justify-center gap-4">
            <Link to="/register" className="rounded-xl bg-emerald-600 px-8 py-4 text-base font-bold text-white shadow-xl shadow-emerald-200 transition-all hover:-translate-y-1 hover:bg-emerald-700 hover:shadow-2xl">
              {t("home.hero.ctaPrimary")}
            </Link>
            <a href="#features" className="rounded-xl border border-gray-200 bg-white px-8 py-4 text-base font-bold text-gray-700 shadow-sm transition-all hover:-translate-y-1 hover:bg-gray-50 hover:shadow-md">
              {t("home.hero.ctaSecondary")}
            </a>
          </div>

          {/* Hero Dashboard Preview Mockup */}
          <div className="mt-16 relative mx-auto max-w-5xl rounded-2xl border border-gray-200 bg-gray-50/50 p-2 shadow-2xl backdrop-blur-sm">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={idx} className="group relative rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl hover:border-emerald-100">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 text-2xl group-hover:scale-110 transition-transform">
                  {feature.icon}
                </div>
