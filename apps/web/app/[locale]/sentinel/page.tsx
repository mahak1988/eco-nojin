...
export default function Page() {
  ...
  const title = dict?.sentinel?.title || (isPersian ? 'تأیید ماهواره‌ای' : 'Satellite Verification');
  const subtitle = dict?.sentinel?.subtitle || (isPersian ? 'این صفحه در حال توسعه است' : 'This page is under development');

  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-white dark:from-gray-900 dark:to-gray-800 pt-24">
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <Satellite className="w-16 h-16 text-cyan-600 mx-auto mb-4" />
