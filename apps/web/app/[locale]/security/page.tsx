...
export default function Page() {
  ...
  const title = dict?.security?.title || (isPersian ? 'داشبورد امنیتی' : 'Security Dashboard');
  const subtitle = dict?.security?.subtitle || (isPersian ? 'این صفحه در حال توسعه است' : 'This page is under development');

  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white dark:from-gray-900 dark:to-gray-800 pt-24">
