...
export default function Page() {
  ...
  const title = dict?.pages.policy?.title || (isPersian ? 'خط مشی' : 'Policy');
  const subtitle = dict?.pages.policy?.subtitle || (isPersian ? 'این صفحه در حال توسعه است' : 'This page is under development');
