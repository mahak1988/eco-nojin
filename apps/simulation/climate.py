"""
Climate Scenario Simulator Simulator
=================
...
class ClimateSimulator(BaseSimulator):
    """Climate Scenario Simulator implementation."""
    ...
    def description(self) -> str:
        return "Simulates climate scenarios (temperature, precipitation, extreme events) based on IPCC pathways."
