"""
RothC (Rothamsted Carbon Model) Simulator
=================
...
class RothCSimulator(BaseSimulator):
    """RothC (Rothamsted Carbon Model) implementation."""
    ...
    @property
    def name(self) -> str:
        return "RothC (Rothamsted Carbon Model)"
    ...
    def description(self) -> str:
        return "RothC simulates soil organic carbon turnover. Models the effects of soil type, temperature, moisture, and plant cover."
