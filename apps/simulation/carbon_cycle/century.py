...
class CenturySimulator(BaseSimulator):
    ...
    @property
    def name(self) -> str: return "CENTURY Biogeochemical Model"
    @property
    def category(self) -> str: return "carbon_cycle"
    @property
    def description(self) -> str: return "CENTURY model for ecosystem dynamics and nutrient cycling. Current skeleton implementation."
    @property
    ...
    def get_parameters(self) -> list[SimulationParameter]:
        return [
            SimulationParameter(name="ecosystem_type", label="Ecosystem Type", type="select", 
                              ...
                              default="grassland", description="Type of ecosystem", required=True),
            SimulationParameter(name="climate_zone", label="Climate Zone", type="select", 
                              options=["temperate", "tropical", "arid", "mediterranean"], 
                              default="temperate", description="Climate zone", required=True),
            SimulationParameter(name="soil_texture", label="Soil Texture", 
                              type="select", options=["clay", "loam", "sand", "silty_loam"], 
                              default="loam", description="Soil texture class", required=True),
            SimulationParameter(name="years", label="Simulation Years", 
                              type="int", default=50, min_value=1, max_value=200, 
                              unit="years", description="Number of years to simulate", required=True),
            SimulationParameter(name="annual_precip", label="Annual Precipitation", 
                              type="float", default=600.0, min_value=100.0, max_value=3000.0, 
                              unit="mm", description="Average annual precipitation", required=True),
        ]
    ...
    def _run_skeleton_simulation(self, params: dict[str, Any]) -> dict:
        ...
        adjusted_rate = (base_carbon_rate * 
        ...
        return {
            "series": [
                {"key": "carbon_stock", "label": "Carbon Stock (tC/ha)", "color": "#10b981", 
                 "values": yearly_values, "kind": "line", "fill": True},
                {"key": "nutrient_level", "label": "Nutrient Level", "color": "#f59e0b", 
                 "values": yearly_nutrient, "kind": "line", "fill": True},
            ],
            "metrics": {
