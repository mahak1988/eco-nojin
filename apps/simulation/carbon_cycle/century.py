"""
CENTURY Soil Organic Matter Model Simulator
=================
...
class CenturySimulator(BaseSimulator):
    """CENTURY Soil Organic Matter Model implementation."""
    ...
    @property
    def name(self) -> str:
        return "CENTURY Soil Organic Matter Model"
    ...
    def description(self) -> str:
        return "CENTURY simulates carbon and nutrient dynamics for grassland, forest, and crop systems over long time scales."
