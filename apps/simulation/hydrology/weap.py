"""
WEAP (Water Evaluation And Planning) Simulator
=================
...
class WEAPSimulator(BaseSimulator):
    """WEAP (Water Evaluation And Planning) implementation."""
    ...
    def description(self) -> str:
        return "WEAP is an integrated water resources planning tool. Simulates water demand, supply, runoff, and allocation."
