...
class RUSLE2Simulator(BaseSimulator):
    ...
    @property
    def name(self) -> str:
        return "RUSLE2 Soil Erosion Model"
    ...
    def description(self) -> str:
        return "Revised Universal Soil Loss Equation 2 for soil erosion prediction. Current skeleton implementation."
    ...
    def get_parameters(self) -> list[SimulationParameter]:
        return [
            ...
            SimulationParameter(
                ...
                max_value=100.0,
                unit="%",
                description="Slope steepness percentage",
                required=True,
            ),
            SimulationParameter(
            ...
            SimulationParameter(
                name="cover_management",
                label="Cover Management (C)",
                type="float",
                default=0.3,
                min_value=0.001,
                max_value=1.0,
            ...
            SimulationParameter(
                name="support_practices",
                label="Support Practices (P)",
                type="float",
                default=1.0,
                min_value=0.1,
                max_value=1.0,
    ...
    def _run_skeleton_simulation(self, params: dict[str, Any]) -> dict:
        ...
        ls_factor = ((slope_length / 22.1) ** m) * (
            0.065 + 0.0456 * slope_steepness * 100 + 0.0065 * (slope_steepness * 100) ** 2
        )
        ...
        return {
            "series": [
                {
                    "key": "cumulative_erosion",
                    "label": "Cumulative Erosion (t/ha)",
                    "color": "#dc2626",
                    "values": monthly_erosion,
                    "kind": "line",
                    "fill": True,
                },
            ],
            "metrics": {
                ...
                "risk_category": "High"
                if annual_loss_tons_per_ha > 10
                else "Medium"
                if annual_loss_tons_per_ha > 5
                else "Low",
            },
        }
