...
class UrbanSimulator(BaseSimulator):
    ...
    @property
    def name(self) -> str:
        return "Urban Growth & Land Use Simulator"
    ...
    def description(self) -> str:
        return "Simulates urban expansion, land use change and population dynamics (cellular-automata style)."
    ...
    def _get_parameters(self) -> list[SimulationParameter]:
        return [
            SimulationParameter(
                ...
                description="Starting population",
                required=False,
            ),
            SimulationParameter(
                name="growth_rate",
            ...
            SimulationParameter(
                name="urban_area_km2",
                label="Initial Urban Area (km2)",
                type="float",
                default=50.0,
                min_value=1.0,
                max_value=5000.0,
                unit="km2",
                description="Initial built-up area",
                required=False,
            ),
            SimulationParameter(
                name="years",
        ...
        return {
            ...
            "metrics": {
                ...
                "population_growth_pct": round(
                    (pop / params.get("initial_population", 100000.0) - 1) * 100, 1
                ),
