...
CLIMATE_ZONES: list[dict[str, Any]] = [
    {
        ...
        "priority_packages": ["swc_agmar", "rangeland_restore", "conservation_ag", "medicinal_diversify"],
    ...
    },
    {
        ...
        "priority_packages": ["salinity_manage", "efficient_irrigation", "drainage", "salt_tolerant_crops"],
