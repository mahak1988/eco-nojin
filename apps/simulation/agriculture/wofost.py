"""
WOFOST (WOrld FOod STudies) Simulator
=================
...
class WOFOSTSimulator(BaseSimulator):
    """WOFOST (WOrld FOod STudies) implementation."""
    ...
    @property
    def name(self) -> str:
        return "WOFOST (WOrld FOod STudies)"
    ...
    def description(self) -> str:
        return "WOFOST simulates crop growth and production for food security analysis. Part of the Crop Growth Monitoring System."
