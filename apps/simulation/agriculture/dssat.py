...
class DSSATSimulator(BaseSimulator):
    ...
    @property
    def name(self) -> str:
        return "DSSAT Cropping Systems Simulator"
    ...
    def description(self) -> str:
        return "Decision Support System for Agrotechnology Transfer for cropping systems simulation. Current skeleton implementation."
    ...
    def get_parameters(self) -> list[SimulationParameter]:
        return [
            ...
            SimulationParameter(
                ...
                type="string",
                default="generic",
                description="Crop variety/cultivar",
                required=True,
            ),
            SimulationParameter(
                name="planting_date",
            ...
            SimulationParameter(
                ...
                max_value=300.0,
                unit="kg/ha",
                description="Total nitrogen applied",
                required=True,
            ),
            SimulationParameter(
    ...
    def _run_skeleton_simulation(self, params: dict[str, Any]) -> dict:
        ...
        # Irrigation effect
        irrigation_factors = {"rainfed": 0.7, "deficit": 0.85, "full": 1.0, "scheduled": 0.95}
        ...
        return {
            "series": [
                ...
                },
                {
                    ...
                    "color": "#22c55e",
                    "values": daily_leaf_area,
                    "kind": "line",
                    "fill": False,
                },
                {
                    "key": "nitrogen",
                    "label": "N Content (kg/ha)",
                    "color": "#3b82f6",
