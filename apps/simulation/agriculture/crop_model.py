"""
Generic Crop Growth Model Simulator
=================
...
class CropModelSimulator(BaseSimulator):
    """Generic Crop Growth Model implementation."""
    ...
    def description(self) -> str:
        return "A simplified generic crop growth model based on light interception, radiation use efficiency, and harvest index."
