"""
LEAP (Low Emissions Analysis Platform) Simulator
=================
...
class LEAPSimulator(BaseSimulator):
    """LEAP (Low Emissions Analysis Platform) implementation."""
    ...
    @property
    def name(self) -> str:
        return "LEAP (Low Emissions Analysis Platform)"
    ...
    def description(self) -> str:
        return "LEAP is an energy planning tool for climate change mitigation. Models energy demand, supply, and emissions."
