"""
EcoNojin Advisory Engine â€” Scientifically grounded, rule-based recommendations.
...
def generate_advisory(simulator_id: str, metrics: Dict[str, Any], parameters: Dict[str, Any]) -> Dict[str, Any]:
    ...
    scenarios = []
        ...
        if annual_rate > 2.0:
            analysis += "Excellent carbon sequestration rate. Soil qualifies for carbon credit programs."
        ...
        if n_stress > 0.3:
            ...
            analysis += "High nitrogen leaching detected. Split fertilizer applications recommended."
            recommendations.append({
                "level": "warning",
                "icon": "alert-triangle",
    ...
    if simulator_id == "aquacrop":
        ...
        analysis = f"ط¹ظ…ظ„ع©ط±ط¯ ط´ط¨غŒظ‡â€Œط³ط§ط²غŒâ€Œط´ط¯ظ‡ {yield_val:.2f} طھظ† ط¯ط± ظ‡ع©طھط§ط± ط§ط³طھ. "
        if yield_val < 3.0:
            analysis += "ط§غŒظ† ظ…ظ‚ط¯ط§ط± ظ†ط´ط§ظ†â€Œط¯ظ‡ظ†ط¯ظ‡ظ” طھظ†ط´ ط´ط¯غŒط¯ (ط¢ط¨غŒ غŒط§ ط؛ط°ط§غŒغŒ) ط¯ط± ط·ظˆظ„ ط¯ظˆط±ظ‡ ط±ط´ط¯ ط§ط³طھ."
            recommendations.append({
                "level": "warning",
                "icon": "droplet",
                "text": "طھظ†ط´ ط¢ط¨غŒ ط´ظ†ط§ط³ط§غŒغŒ ط´ط¯. طھظˆطµغŒظ‡ ظ…غŒâ€Œط´ظˆط¯ ط¢ط¨غŒط§ط±غŒ طھع©ظ…غŒظ„غŒ ط¯ط± ظ…ط±ط§ط­ظ„ ط­ط³ط§ط³ (ع¯ظ„ط¯ظ‡غŒ ظˆ ظ¾ط± ط´ط¯ظ† ط¯ط§ظ†ظ‡) ط§ط¹ظ…ط§ظ„ ط´ظˆط¯.",
        ...
        if wue > 0 and wue < 1.0:
            recommendations.append({
                "level": "warning",
                "icon": "trending-down",
                "text": "ط¨ظ‡ط±ظ‡â€Œظˆط±غŒ ط¢ط¨ (WUE) ظ¾ط§غŒغŒظ† ط§ط³طھ. ط¨ط±ط±ط³غŒ ظ†ط´طھ ط³غŒط³طھظ… ط¢ط¨غŒط§ط±غŒ غŒط§ ط§ط³طھظپط§ط¯ظ‡ ط§ط² ط±ظˆط´â€Œظ‡ط§غŒ ظ‚ط·ط±ظ‡â€Œط§غŒ طھظˆطµغŒظ‡ ظ…غŒâ€Œط´ظˆط¯.",
        ...
        scenarios = [
            {
                ...
                "desc": "ط§ط¹ظ…ط§ظ„ غµغ° ظ…غŒظ„غŒâ€Œظ…طھط± ط¢ط¨غŒط§ط±غŒ ط§ط¶ط§ظپغŒ ط¯ط± ظ…ط±ط­ظ„ظ‡ ع¯ظ„ط¯ظ‡غŒ",
                "params": {"total_irrigation": parameters.get("total_irrigation", 250) + 50}
            },
            {
                "id": "drip_efficiency",
                "name": "ط§ط±طھظ‚ط§ط، ط¨ظ‡ ط¢ط¨غŒط§ط±غŒ ظ‚ط·ط±ظ‡â€Œط§غŒ",
                "desc": "ع©ط§ظ‡ط´ طھظ„ظپط§طھ طھط¨ط®غŒط± ظˆ ط§ظپط²ط§غŒط´ ط¨ظ‡ط±ظ‡â€Œظˆط±غŒ ط¢ط¨",
                "params": {"total_irrigation": parameters.get("total_irrigation", 250) * 0.8} # 20% savings
            }
        ]
        references = ["Steduto P. et al. (2009). AquaCrop â€” The FAO Crop Model to Simulate Yield Response to Water. FAO Irrigation & Drainage Paper 66."]

    elif simulator_id == "cba":
        npv = metrics.get("npv_m_usd", 0)
        irr = metrics.get("irr_pct", 0)
        
        analysis = f"ط§ط±ط²ط´ ط®ط§ظ„طµ ظپط¹ظ„غŒ (NPV) ظ¾ط±ظˆعکظ‡ ط¨ط±ط§ط¨ط± ط¨ط§ {npv:.2f} ظˆ ظ†ط±ط® ط¨ط§ط²ط¯ظ‡ ط¯ط§ط®ظ„غŒ (IRR) ط¨ط±ط§ط¨ط± {irr:.1f}ظھ ط§ط³طھ. "
        if npv > 0 and irr > 8.0:
            analysis += "ظ¾ط±ظˆعکظ‡ ط§ط² ظ†ط¸ط± ط§ظ‚طھطµط§ط¯غŒ ع©ط§ظ…ظ„ط§ظ‹ طھظˆط¬غŒظ‡â€Œظ¾ط°غŒط± ظˆ ط³ظˆط¯ط¢ظˆط± ط§ط³طھ."
            recommendations.append({
                "level": "success",
                "icon": "trending-up",
            ...
            analysis += "ظ¾ط±ظˆعکظ‡ ط¯ط± ظ…ط±ط² طھظˆط¬غŒظ‡â€Œظ¾ط°غŒط±غŒ ظ‚ط±ط§ط± ط¯ط§ط±ط¯ غŒط§ ط²غŒط§ظ†â€Œط¯ظ‡ ط§ط³طھ."
            recommendations.append({
                "level": "warning",
                "icon": "alert-triangle",
                "text": "NPV ظ…ظ†ظپغŒ غŒط§ ظ¾ط§غŒغŒظ† ط§ط³طھ. ظ¾غŒط´ظ†ظ‡ط§ط¯ ظ…غŒâ€Œط´ظˆط¯ ظ‡ط²غŒظ†ظ‡â€Œظ‡ط§غŒ ط³ط±ظ…ط§غŒظ‡â€Œع¯ط°ط§ط±غŒ ط§ظˆظ„غŒظ‡ ط±ط§ ع©ط§ظ‡ط´ ط¯ظ‡غŒط¯ غŒط§ ط¨ظ‡ ط¯ظ†ط¨ط§ظ„ طھط³ظ‡غŒظ„ط§طھ ط¨ط§ ظ†ط±ط® ط¨ظ‡ط±ظ‡ ظ¾ط§غŒغŒظ†â€Œطھط± ط¨ط§ط´غŒط¯.",
        ...
        scenarios = [
            {
                "id": "cost_reduction",
                "name": "ع©ط§ظ‡ط´ غ²غ°ظھ ظ‡ط²غŒظ†ظ‡â€Œظ‡ط§غŒ ط§ط¬ط±ط§غŒغŒ",
                "desc": "ط¨ط±ط±ط³غŒ ط­ط³ط§ط³غŒطھ ظ¾ط±ظˆعکظ‡ ط¨ظ‡ ط¨ظ‡غŒظ†ظ‡â€Œط³ط§ط²غŒ ظ‡ط²غŒظ†ظ‡â€Œظ‡ط§",
                "params": {"annual_cost": parameters.get("annual_cost", 500) * 0.8}
            },
            {
                "id": "subsidy",
                "name": "ط§ط¹ظ…ط§ظ„ غŒط§ط±ط§ظ†ظ‡ ط¯ظˆظ„طھغŒ",
                "desc": "ع©ط§ظ‡ط´ ظ†ط±ط® طھظ†ط²غŒظ„ ظ…ط¤ط«ط± ط¨ظ‡ ط¯ظ„غŒظ„ طھط³ظ‡غŒظ„ط§طھ",
        ...
        analysis = f"ظ…غŒط²ط§ظ† ظپط±ط³ط§غŒط´ ط®ط§ع© ط´ط¨غŒظ‡â€Œط³ط§ط²غŒâ€Œط´ط¯ظ‡ {soil_loss:.2f} طھظ† ط¯ط± ظ‡ع©طھط§ط± ط¯ط± ط³ط§ظ„ ط§ط³طھ. "
        if soil_loss > 10.0: # Tolerable soil loss is often around 10 t/ha/yr
            analysis += "ط§غŒظ† ظ…ظ‚ط¯ط§ط± ط¨غŒط´ ط§ط² ط­ط¯ ظ…ط¬ط§ط² ظپط±ط³ط§غŒط´ (T-value) ط§ط³طھ ظˆ ظ†غŒط§ط² ط¨ظ‡ ظ…ط¯ط§ط®ظ„ظ‡ ظپظˆط±غŒ ط¯ط§ط±ط¯."
            recommendations.append({
                "level": "warning",
                "icon": "alert-octagon",
                "text": "ظپط±ط³ط§غŒط´ ط®ط§ع© ط´ط¯غŒط¯ ط§ط³طھ. ط§ط¬ط±ط§غŒ ط¹ظ…ظ„غŒط§طھ ط­ظپط§ط¸طھغŒ ظ…ط§ظ†ظ†ط¯ ع©ط´طھ ظ†ظˆط§ط±غŒطŒ طھط±ط§ط³â€Œط¨ظ†ط¯غŒ غŒط§ ط§ظپط²ط§غŒط´ ظ¾ظˆط´ط´ ع¯غŒط§ظ‡غŒ ط§ع©غŒط¯ط§ظ‹ طھظˆطµغŒظ‡ ظ…غŒâ€Œط´ظˆط¯.",
                "source": "USDA Agriculture Handbook 703 (RUSLE2)"
            })
        else:
            analysis += "ظ…غŒط²ط§ظ† ظپط±ط³ط§غŒط´ ط¯ط± ظ…ط­ط¯ظˆط¯ظ‡ظ” ظ‚ط§ط¨ظ„ ظ‚ط¨ظˆظ„ ظˆ ظ¾ط§غŒط¯ط§ط± ظ‚ط±ط§ط± ط¯ط§ط±ط¯."
            recommendations.append({
                "level": "success",
                "icon": "shield",
        ...
        scenarios = [
            {
                "id": "contour_farming",
                "name": "ع©ط´طھ ط±ظˆغŒ ط®ط·ظˆط· طھط±ط§ط² (Contour)",
        ...
        analysis = "طھط­ظ„غŒظ„ طھط®طµطµغŒ ظ…طھظ†غŒ ط¨ط±ط§غŒ ط§غŒظ† ط´ط¨غŒظ‡â€Œط³ط§ط² ط¯ط± ط­ط§ظ„ طھظˆط³ط¹ظ‡ ط§ط³طھ. ظ„ط·ظپط§ظ‹ ط¨ظ‡ ط®ط±ظˆط¬غŒâ€Œظ‡ط§غŒ ط¹ط¯ط¯غŒطŒ ظ†ظ…ظˆط¯ط§ط±ظ‡ط§ ظˆ ط¨ط®ط´ ط§ط¹طھط¨ط§ط±ط³ظ†ط¬غŒ طھظˆط¬ظ‡ ع©ظ†غŒط¯."
        recommendations = [{
            "level": "info",
            "icon": "info",
            "text": "ظ‚ظˆط§ظ†غŒظ† طھظˆطµغŒظ‡ظ” ظ…ط³طھظ†ط¯ ط¨ط±ط§غŒ ط§غŒظ† ظ…ط§عکظˆظ„ ط¨ظ‡â€Œط²ظˆط¯غŒ ط¨ط± ط§ط³ط§ط³ ظ…ظ‚ط§ظ„ط§طھ ظ…ط±ط¬ط¹ ط§ط¶ط§ظپظ‡ ط®ظˆط§ظ‡ط¯ ط´ط¯.",
