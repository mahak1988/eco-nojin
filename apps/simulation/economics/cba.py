"""
Cost-Benefit Analysis Model Simulator
=================
...
class CBASimulator(BaseSimulator):
    """Cost-Benefit Analysis Model implementation."""
    ...
    def description(self) -> str:
        return "CBA evaluates economic feasibility of projects by comparing costs and benefits over time with NPV and IRR."
