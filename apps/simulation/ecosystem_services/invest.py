"""
InVEST (Integrated Valuation of Ecosystem Services) Simulator
=================
...
class InVESTSimulator(BaseSimulator):
    """InVEST (Integrated Valuation of Ecosystem Services) implementation."""
    ...
    @property
    def name(self) -> str:
        return "InVEST (Integrated Valuation of Ecosystem Services)"
    ...
    def description(self) -> str:
        return "InVEST models ecosystem services including carbon storage, water purification, pollination, and recreation."
