...
class TestFeatures:
    ...
    def test_vector_from_dict_length(self):
        from apps.ml.features import vector_from_dict, FEATURE_NAMES
...
class TestClassicalModels:
    ...
    def test_model_bundle_creation(self):
        from apps.ml.classical import fit_linear, fit_logistic, fit_zscore, ModelBundle
        X = [[1.0, 0.5], [0.2, 0.8], [0.5, 0.5], [0.9, 0.1], [0.1, 0.9]]
...
class TestMLService:
    ...
    def test_predict_bundle_output_shape(self):
        from apps.ml.service import train_default_models, predict_bundle
        from apps.ml.features import FEATURE_NAMES
    ...
    def test_get_bundle_consistent(self):
        ...
        from apps.ml.service import train_default_models, get_bundle
