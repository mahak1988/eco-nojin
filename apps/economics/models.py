...
class EconomicAnalysis(Base):
    ...
    farm_id: Mapped[int | None] = mapped_column(
        Integer, ForeignKey("farms.id"), nullable=True, index=True
    )
    ...
    npv: Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    break_even_point: Mapped[float | None] = mapped_column(Float, nullable=True)
...
class CostItem(Base):
    ...
    analysis_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("economic_analyses.id"), nullable=False, index=True
    )
    ...
    analysis: Mapped[EconomicAnalysis] = relationship(
        "EconomicAnalysis", back_populates="cost_items"
    )
...
class BenefitItem(Base):
    ...
    analysis: Mapped[EconomicAnalysis] = relationship(
        "EconomicAnalysis", back_populates="benefit_items"
    )
