...
class AgricultureSchool(Base):
    ...
    # Relationships
    fields: Mapped[list["SchoolField"]] = relationship(
        "SchoolField", back_populates="school", cascade="all, delete-orphan"
    )
...
class SchoolField(Base):
    ...
    school_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("agriculture_schools.id"), nullable=False, index=True
    )
