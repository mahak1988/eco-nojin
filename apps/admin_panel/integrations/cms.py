...
class CMSIntegrationService:
    ...
    async def get_content_items(
        self, content_type: str, params: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
...
_cms_service: Optional[CMSIntegrationService] = None


def init_cms_service_from_env() -> Optional[CMSIntegrationService]:
    global _cms_service
...
def init_cms_service(base_url: str, api_key: Optional[str] = None) -> CMSIntegrationService:
    global _cms_service
