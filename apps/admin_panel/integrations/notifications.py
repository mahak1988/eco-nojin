...
class NotificationService:
    ...
    async def mark_as_read(self, notification_ids: List[int], user_id: Optional[int] = None) -> bool:
        ...
        try:
            ...
            for notification in self.notifications:
                if notification["id"] in notification_ids:
                    ...
                    if not user_id or (notification["recipients"] and str(user_id) in notification["recipients"]):
...
def init_notification_service(base_url: Optional[str] = None, api_key: Optional[str] = None):
