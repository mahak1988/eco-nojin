...
MOCK_SETTINGS = [
    type("AdminSetting", (), {
        "id": 1, "key": "site_name", "value": "Econojin",
        "description": "Site name", "is_active": True,
        "created_at": datetime(2025, 1, 1, tzinfo=timezone.utc),
        "updated_at": datetime(2025, 1, 1, tzinfo=timezone.utc),
        "__repr__": lambda s: f"<AdminSetting(key={s.key})>",
    })(),
    type("AdminSetting", (), {
        "id": 2, "key": "max_users", "value": "10000",
        "description": "Max registered users", "is_active": True,
...
MOCK_USERS = [
    type("User", (), {
        ...
        "phone": "+1234567890", "organization": "Econojin",
    ...
    type("User", (), {
        ...
        "role": "farmer", "is_active": True, "is_superuser": False,
        "created_at": datetime(2025, 1, 2, tzinfo=timezone.utc),
        "updated_at": datetime(2025, 1, 2, tzinfo=timezone.utc),
        "__repr__": lambda s: f"<User(id={s.id})>",
    })(),
    type("User", (), {
        "id": 3, "email": "inactive@example.com", "full_name": "Inactive User",
        "phone": None, "organization": None,
        "role": "farmer", "is_active": False, "is_superuser": False,
...
MOCK_AUDIT_LOGS = [
    ...
    type("AuditLog", (), {
        "id": 2, "actor_id": 2, "actor_email": "user@example.com",
        "event_type": "login", "event_data": '{"ip": "127.0.0.2"}',
...
MOCK_REPORTS = [
    type("SystemReport", (), {
        "id": 1, "report_name": "Weekly Performance", "status": "completed",
...
def create_mock_admin_service():
    ...
    mock.upsert_system_setting.return_value = type("AdminSetting", (), {
        "id": 1, "key": "test_key", "value": "test_value",
        "description": "Test setting", "is_active": True,
        "created_at": datetime(2025, 1, 1, tzinfo=timezone.utc),
        "updated_at": datetime(2025, 1, 1, tzinfo=timezone.utc),
    })()
    ...
    mock.create_system_report.return_value = type("SystemReport", (), {
        "id": 3, "report_name": "Test Report", "status": "completed",
    ...
    mock.update_user_status.return_value = type("User", (), {
        "id": 2, "email": "user@example.com", "full_name": "Regular User",
        "phone": None, "organization": None, "role": "farmer",
        "is_active": False, "is_superuser": False,
        "created_at": datetime(2025, 1, 1, tzinfo=timezone.utc),
        "updated_at": datetime(2025, 1, 1, tzinfo=timezone.utc),
    })()
    mock.update_user_role.return_value = type("User", (), {
        "id": 2, "email": "user@example.com", "full_name": "Regular User",
        "phone": None, "organization": None, "role": "farmer",
...
class TestAdminDashboard:
    ...
    def test_dashboard_has_all_required_fields(self):
        response = client.get("/api/v1/admin/")
        assert response.status_code == 200
        required_fields = ["user_count", "active_user_count", "superuser_count",
                          "total_settings", "total_audit_logs", "total_reports"]
...
class TestAdminSettings:
    ...
    def test_upsert_setting(self, override_deps):
        ...
        mock_service.upsert_system_setting.return_value = type("AdminSetting", (), {
            "id": 1, "key": "test_key", "value": "new_value",
...
class TestAdminUsers:
    ...
    def test_update_user_status(self, override_deps):
        override_deps.update_user_status.return_value = type("User", (), {
            "id": 2, "email": "user@example.com", "full_name": "Regular User",
            "phone": None, "organization": None, "role": "farmer",
            "is_active": False, "is_superuser": False,
            "created_at": datetime(2025, 1, 1, tzinfo=timezone.utc),
    ...
    def test_update_user_role(self, override_deps):
        override_deps.update_user_role.return_value = type("User", (), {
            "id": 2, "email": "user@example.com", "full_name": "Regular User",
            "phone": None, "organization": None, "role": "farmer",
            "is_active": True, "is_superuser": True,
            "created_at": datetime(2025, 1, 1, tzinfo=timezone.utc),
...
class TestAdminReports:
    ...
    def test_generate_report(self):
        response = client.post("/api/v1/admin/reports", json={
...
class TestSystemHealth:
    ...
    def test_health_has_all_required_fields(self):
        response = client.get("/api/v1/admin/health")
        assert response.status_code == 200
        required = ["database", "database_latency_ms", "redis", "uptime_seconds",
                    "total_users", "active_users_last_24h", "total_api_routes",
