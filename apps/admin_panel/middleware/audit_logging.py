...
class AuditLoggingMiddleware:
    ...
    async def log_request(self, request: Request, user: Optional[User]):
    ...
    async def log_response(self, request: Request, response: Response, processing_time: float, user: Optional[User]):
    ...
    async def log_security_event(self, request: Request, user: Optional[User], event_type: str, event_data: dict):
    ...
    async def record_audit_event(self, event_type: str, event_data: dict, user: Optional[User]):
