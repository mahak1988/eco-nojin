...
class FallbackBrain:
    ...
    async def generate_response(
        ...
        try:
            ...
            # 3. ارزیابی قوانین
            rules_summary = await self.rules_engine.get_actions_summary(agent_type, context)
            ...
            if knowledge_context:
                ...
                # استفاده از template
                response = await self.template_engine.get_response(agent_type, intent, context)
    ...
    async def _save_to_memory(self, agent_type: str, user_id: int, message: str, intent: str):
