"""
shared_knowledge models | مدل‌های shared_knowledge
=====================================
SQLAlchemy ORM models for the shared_knowledge module.
...
class SharedKnowledge(Base):
    """Primary shared_knowledge entity."""
    ...
    def __repr__(self) -> str:
        return f"<SharedKnowledge(id={self.id}, name={self.name!r})>"
