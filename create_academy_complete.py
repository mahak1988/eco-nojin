...
print("=" * 80)
print("📚 CREATING ALL ACADEMY PAGES")
print("=" * 80)
...
(frontend_path / 'app/academy/page.tsx').write_text(main_page, encoding='utf-8')
print("✅ Created app/academy/page.tsx")

print("\n✅ Main academy page created!")
print("\n🚀 Next: Create course detail and lesson pages")