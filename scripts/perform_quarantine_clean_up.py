...
def perform_quarantine_clean_up(file_list, backup_dir_name="_QUARANTINE_AUTOMATED"):
    ...
    print(f"Starting automated quarantine process for {len(file_list)} items into {quarantine_path}/")
...
if __name__ == "__main__":
    ...
    print("WARNING: This script will move files. Please review the 'junk_items' list in the script.")
