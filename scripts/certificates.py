...
class CertificateGenerator:
    ...
    def update_certificate(
        ...
        cert.growth_stage = self._calculate_growth_stage(cert.activity_type, cert.current_carbon_kg)
    ...
    def generate_portfolio_report(self, owner: str) -> Dict:
        ...
        return {
            ...
            "verified_count": sum(1 for c in user_certs if c.satellite_verified or c.iot_verified),
