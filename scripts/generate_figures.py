...
from scripts.research.plot_utils import plot_scenario_comparison, plot_uncertainty_bands, plot_yield_soc_scatter
...
def main():
    ...
    plot_uncertainty_bands(unc["yield"]["samples"] if "samples" in unc["yield"] else [3200]*1000, 
                          "output/figures/fig2_uncertainty_yield.png", ylabel="Yield (kg/ha)")
