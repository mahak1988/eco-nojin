...
class ERA5Client:
    ...
    def download_monthly(
        ...
        self.client.retrieve("reanalysis-era5-single-levels-monthly-means", request, output_path)
    ...
    def download_hourly(
        ...
        self.client.retrieve("reanalysis-era5-single-levels", request, output_path)

        return output_path

    def process_for_model(
        self, file_path: Path, target_variables: Dict[str, str], target_crs: str = "EPSG:4326"
    ) -> xr.Dataset:
        """
