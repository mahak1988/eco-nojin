...
SIMULATORS = [
    ...
    # ── Agriculture (5) ──
    (
        "apps/simulation/agriculture/apsim.py",
        "APSIMSimulator",
        "apsim",
    ...
    (
        "apps/simulation/agriculture/dssat.py",
        "DSSATSimulator",
        "dssat",
    ...
    (
        "apps/simulation/agriculture/aquacrop.py",
        "AquaCropSimulator",
        "aquacrop",
    ...
    (
        "apps/simulation/agriculture/wofost.py",
        "WOFOSTSimulator",
        "wofost",
    ...
    (
        "apps/simulation/agriculture/crop_model.py",
        "CropModelSimulator",
        "crop-model",
    ...
    # ── Hydrology (5) ──
    (
        "apps/simulation/hydrology/swat.py",
        "SWATSimulator",
        "swat",
    ...
    (
        "apps/simulation/hydrology/hecras.py",
        "HECRASSimulator",
        "hecras",
    ...
    (
        "apps/simulation/hydrology/bridge.py",
        "BridgeSimulator",
        "bridge",
        "Hydrological Bridge Model",
        "hydrology",
        "A conceptual hydrological model bridging rainfall-runoff processes with water quality indicators.",
    ),
    # ── Carbon Cycle (3) ──
    (
        "apps/simulation/carbon_cycle/rothc.py",
        "RothCSimulator",
        "rothc",
    ...
    (
        "apps/simulation/carbon_cycle/co2fix.py",
        "CO2FIXSimulator",
        "co2fix",
        "CO2FIX (Carbon Sequestration Model)",
        "carbon-cycle",
        "CO2FIX simulates carbon sequestration in forest ecosystems. Includes biomass, soil, and product pools.",
    ),
    (
        "apps/simulation/carbon_cycle/century.py",
        "CenturySimulator",
        "century",
    ...
    # ── Economics (3) ──
    (
        "apps/simulation/economics/abm.py",
        "ABMSimulator",
        "abm",
    ...
    (
        "apps/simulation/economics/teeb.py",
        "TEEBSimulator",
        "teeb",
    ...
    (
        "apps/simulation/economics/cba.py",
        "CBASimulator",
        "cba",
    ...
    (
        "apps/simulation/ecosystem_services/invest.py",
        "InVESTSimulator",
        "invest",
    ...
    (
        "apps/simulation/ecosystem_services/aries.py",
        "ARIESSimulator",
        "aries",
    ...
    # ── Energy (2) ──
    (
        "apps/simulation/energy/homer.py",
        "HOMERSimulator",
        "homer",
    ...
    (
        "apps/simulation/energy/leap.py",
        "LEAPSimulator",
        "leap",
    ...
    (
        "apps/simulation/soil/rusle2.py",
        "RUSLE2Simulator",
        "rusle2",
    ...
    # ── Water Quality (2) ──
    (
        "apps/simulation/water_quality/qual2k.py",
        "QUAL2KSimulator",
        "qual2k",
        "QUAL2K (River Water Quality Model)",
        "water-quality",
        "QUAL2K simulates water quality in streams and rivers. Models dissolved oxygen, nutrients, algae, and pathogens.",
    ),
    (
        "apps/simulation/water_quality/wasp.py",
        "WASPSimulator",
        "wasp",
    ...
    # ── Biodiversity (2) ──
    (
        "apps/simulation/biodiversity/maxent.py",
        "MaxEntSimulator",
        "maxent",
    ...
    # ── Urban (1) ──
    (
        "apps/simulation/urban.py",
        "UrbanSimulator",
        "urban",
        "Urban Growth & Land Use Simulator",
        "urban",
