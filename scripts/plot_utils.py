...
def plot_scenario_comparison(data: dict, output_path: str):
    ...
    df.plot(x="Scenario", y=["yield_change_pct", "soc_change_t_ha_10yr"], 
...
def plot_uncertainty_bands(samples: list, output_path: str, xlabel: str = "Simulation", ylabel: str = "Value"):
...
def plot_yield_soc_scatter(data: list, output_path: str):
    ...
    sns.scatterplot(data=df, x="yield_kg_ha", y="soc_change_t_ha", 
                   hue="management_code", palette="viridis", ax=ax)
