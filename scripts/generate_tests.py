...
class TestGenerator:
    ...
    def generate_test_code(self, module_path: str, function: Dict) -> str:
...
'''
    ...
    def generate_test_file(self, source_file: Path, functions: List[Dict]) -> Optional[Path]:
        """تولید فایل تست کامل"""
...
'''
    ...
    def generate_all(self) -> Dict:
        ...
        results = {"files_processed": 0, "test_files_created": 0, "total_tests": 0}
