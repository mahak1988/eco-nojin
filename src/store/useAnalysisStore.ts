...
import { Analysis, Region, RealtimeEvent, EconomicInputs, NdviDataPoint, AnalysisRequest } from '../types';
...
export const useAnalysisStore = create<AnalysisState>()(
  devtools((set) => ({
    ...
    startAnalysis: async (payload) => {
      // پاک کردن وضعیت قبلی و شروع حالت لودینگ
      set({ 
        isLoading: true, 
        error: null, 
        events: [], 
      ...
      try {
        ...
        // اگر موفق بود، sessionId را ست می‌کنیم تا هوک WebSocket فعال شود
