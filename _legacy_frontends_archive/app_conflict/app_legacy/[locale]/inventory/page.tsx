...
export default function Page() {
  ...
  const title = dict?.inventory?.title || (isPersian ? 'مدیریت انبار' : 'Inventory');
  const subtitle = dict?.inventory?.subtitle || (isPersian ? 'این صفحه در حال توسعه است' : 'This page is under development');

  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-white dark:from-gray-900 dark:to-gray-800 pt-24">
