...
export default function Page() {
  ...
  const title = dict?.pages.terms?.title || (isPersian ? 'قوانین' : 'Terms');
  const subtitle = dict?.pages.terms?.subtitle || (isPersian ? 'این صفحه در حال توسعه است' : 'This page is under development');

  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 pt-24">
