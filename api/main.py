...
app = FastAPI(
    title="Econojin API",
    description="پلتفرم علمی احیای مناظر خشک و نیمه‌خشک",
    version="2.0.0",
    lifespan=lifespan,
)
...
print(
    "✅ All routers registered: IoT, Maintenance, MRV, Soil Water, Weather, Drought, Library, Scientific"
)
