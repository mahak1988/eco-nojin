...
print("=" * 80)
print("🔧 REBUILDING ECOCOIN ROUTER FROM SCRATCH")
print("=" * 80)
...
if router_path.exists():
    ...
    router_path.rename(backup_path)
    print(f"✅ Backed up original to {backup_path}")

# Create new router from scratch
new_router = '''"""
...
print("✅ New router.py created successfully!")

# Verify
print("\n🔍 Verifying new router...")
content = router_path.read_text(encoding='utf-8')
print(f"   - File size: {len(content)} bytes")
print(f"   - Lines: {len(content.split(chr(10)))}")
print(f"   - Endpoints: {content.count('@router.')}")
print(f"   - Has router definition: {'router = APIRouter' in content}")

print("\n" + "=" * 80)
print("✅ ECOCOIN ROUTER REBUILT")
print("=" * 80)
print("\n🚀 Next steps:")
