...
export default function Page() {
  ...
  const title = dict?.maahak?.title || (isPersian ? 'کارتابل ماهک' : 'Maahak Console');
  const subtitle = dict?.maahak?.subtitle || (isPersian ? 'این صفحه در حال توسعه است' : 'This page is under development');

  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-white dark:from-gray-900 dark:to-gray-800 pt-24">
