...
export default function Page() {
  ...
  const title = dict?.common?.title || (isPersian ? 'نقشه' : 'Map');
  const subtitle = dict?.common?.subtitle || (isPersian ? 'این صفحه در حال توسعه است' : 'This page is under development');
