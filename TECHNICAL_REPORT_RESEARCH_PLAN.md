...
### ✅ فاز ۰ — راهاندازی و راستیآزمایی (در دست اجرا)
| # | اقدام | وضعیت |
|---|---|---|
| ۰.۱ | بررسی پیکربندیها | ✅ انجام شد |
| ۰.۲ | ایجاد `DEVELOPMENT_PLAN.md` | ✅ انجام شد |
| ۰.۳ | تکمیل شواهد معماری و تستها | ✅ انجام شد |
| ۰.۴ | نصب وابستگیها (`pip install -r requirements.txt`) | ⬜ |
| ۰.۵ | اجرای تستهای baseline (`pytest`) | ⬜ |
| ۰.۶ | راهاندازی API لوکال و بررسی `/health` و `/api/v1/debug/routers` | ⬜ |
